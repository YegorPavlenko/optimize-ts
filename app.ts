/*
 ...
 Серверная часть (server side) - веб сервер обрабатывающий запросы с веб-страниц или с SPA или мобильное приложение.
 ...
 минимальный деловой остаток - минимальный остаток который есть смысл ложить на склад (stock),
 в надежде, что из него в следующие подходы можно будет вырезать кусок (minWaste);
 ...
 минимальный деловой остаток - минимальный остаток который есть смысл ложить на склад (stock),
 в надежде, что из него в следующие подходы можно будет вырезать кусок (minWaste, мм, Integer);
 ...
 Минимальная длина заготовки, которую можно вырезать (minBar) должна быть меньше размера
 ...
 Минимальный деловой остаток должен быть меньше размера цельной заготовки (fullBar) при размере
 ...
 Варианты расчета:
 Жесткий приоритет остатков (должны быть остатки, если нет остаткой вернутьс с предупреждением что их нет) - сначала
